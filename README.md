...
* caffe-pr("Make R-CNN the Caffe detection example"): <https://github.com/BVLC/caffe/pull/482> ⭐ 34,556 | 🐛 1,179 | 🌐 C++ | 📅 2024-07-31
...
* github:<https://github.com/ultralytics/yolov3> ⭐ 10,598 | 🐛 4 | 🌐 Python | 📅 2026-08-28
...
* github: <https://github.com/CPFL/Autoware/tree/feature/cnn_lidar_detection> ⭐ 12,028 | 🐛 72 | 🌐 Dockerfile | 📅 2026-08-24
