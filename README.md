...
* github: <https://github.com/rbgirshick/rcnn> ⭐ 2,414 | 🐛 54 | 🌐 Matlab | 📅 2017-04-03
* intro: R-CNN
...
* github(official, Matlab): <https://github.com/ShaoqingRen/faster_rcnn> ⭐ 2,833 | 🐛 142 | 🌐 Matlab | 📅 2018-07-26
...
* github(Keras): <https://github.com/matterport/Mask_RCNN> ⭐ 25,571 | 🐛 2,022 | 🌐 Python | 📅 2024-06-07
...
* github: <https://github.com/pjreddie/darknet> ⭐ 26,496 | 🐛 1,978 | 🌐 C | 📅 2024-05-03
...
* github(Windows): <https://github.com/AlexeyAB/darknet> ⭐ 22,144 | 🐛 5,445 | 🌐 C | 📅 2025-12-15
...
* github(Official):<https://github.com/pjreddie/darknet> ⭐ 26,496 | 🐛 1,978 | 🌐 C | 📅 2024-05-03
* github:<https://github.com/ultralytics/yolov3> ⭐ 10,606 | 🐛 4 | 🌐 Python | 📅 2026-09-10
...
* github: <https://github.com/CPFL/Autoware/tree/feature/cnn_lidar_detection> ⭐ 12,061 | 🐛 69 | 🌐 Dockerfile | 📅 2026-09-09
...
* [Detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,707 | 🐛 592 | 🌐 Python | 📅 2026-08-19: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
* [mmdetection(SenseTime\&CUHK)](https://github.com/open-mmlab/mmdetection) ⭐ 32,923 | 🐛 1,962 | 🌐 Python | 📅 2024-08-21: mmdetection is an open source object detection toolbox based on PyTorch. It is a part of the open-mmlab project developed by [Multimedia Laboratory, CUHK](http://mmlab.ie.cuhk.edu.hk/).
