...
* caffe-pr("Make R-CNN the Caffe detection example"): <https://github.com/BVLC/caffe/pull/482> ⭐ 34,562 | 🐛 1,566 | 🌐 C++ | 📅 2024-07-31
...
* github(Windows): <https://github.com/AlexeyAB/darknet> ⭐ 22,157 | 🐛 5,438 | 🌐 C | 📅 2025-12-15
...
* github:<https://github.com/ultralytics/yolov3> ⭐ 10,591 | 🐛 4 | 🌐 Python | 📅 2026-08-15
...
* github: <https://github.com/CPFL/Autoware/tree/feature/cnn_lidar_detection> ⭐ 11,991 | 🐛 74 | 🌐 Dockerfile | 📅 2026-08-17
...
* [Detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,668 | 🐛 586 | 🌐 Python | 📅 2026-07-24: Detectron2 is FAIR's next-generation research platform for object detection and segmentation.
